...
const CardSection = () => {
  return (
    <div className="card-section_container section-padding">
      <CardData image={Sedans} header="SEDANS" text="Choose a sedan for its affordability and excellent fuel economoy. Ideal for cruising in the city or on your next road trip." />
      <CardData image={SUVS} header="SUVS" text="Take an SUV for its spacious interior, power, and versatility. Perfect for your next family vacation and off-road adventures." />
